    ...
    <div className="container_main_content" id="profile_page_main">
      <div id="lateral_profile_page_main">
        ...
        <div className="valoracion-container">
          <p className="titleValoracion">Valoracion</p>
          <img
      ...
      <div id="main_content_profile_page_main">
        ...
        <p className="userProfileDesc">
          ...
          tellus eleifend, rutrum purus vel, faucibus tellus. Maecenas efficitur
          lacus a aliquet scelerisque. Aenean vitae tincidunt magna.
        </p>
        <div id="text_into_bar">
          <p>
            <div className="contacts_Profile">Contactos:</div>
            <br />
