        ...
        {(matches) => {
          return matches ? (
            <div
              id={
                isHidden
                  ? 'main-wrapper-side-bar-shown'
                  : 'main-wrapper-side-bar-hidden'
              }
            ...
            >
              ...
              <div id="app-ajustment-options">
                <Link to="/ajustes" className="new-link">
                  <FaCog />{' '}
                </Link>
                <Link to="/ayuda" className="new-link">
                  <FaQuestion />{' '}
                </Link>
                <Link to="/report" className="new-link">
                  <FaExclamationTriangle />
                </Link>
              </div>
            </div>
