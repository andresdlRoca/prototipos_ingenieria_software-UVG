...
export default function BandejaEntrada() {
  ...
  return (
    <>
      <div id="inboxpage">
        <MensajeUI
          chequearVisibilidad={ventanaChat}
          cerrarChat={cerrarChat}
          nombre_usuario={currentChatUser}
        />
        <div id="inbox">
          <div id="headerinbox">
          ...
          <div className="inboxMessages">
            <div className="Messages" onClick={() => abrirChat('Fulanito')}>
              ...
              <p id="sentMessage">
                ...
                viverra mi a fringilla posuere. Aenean pulvinar, dui nec
                ultrices cursus, tellus lectus fermentum lacus, sed finibus enim
                mauris ut sapien. Phasellus vulputate nulla ac sollicitudin
                ultricies.{' '}
              </p>
            </div>
