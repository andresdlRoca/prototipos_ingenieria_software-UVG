...
test('renders Pregunta2', () => {
  render(<Pregunta2 />);
});

test('renders Pregunta3', () => {
  render(<Pregunta3 />);
});

test('renders Pregunta4', () => {
  render(<Pregunta4 />);
});

test('renders Pregunta5', () => {
  render(<Pregunta5 />);
});

test('renders Pregunta6', () => {
  render(<Pregunta6 />);
});

test('renders Pregunta7', () => {
  render(<Pregunta7 />);
});

test('renders Pregunta8', () => {
  render(<Pregunta8 />);
});

test('renders Pregunta9', () => {
  render(<Pregunta9 />);
});
